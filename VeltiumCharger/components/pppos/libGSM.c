...
{
	.cmd = "AT+CGDCONT=1,\"IP\",\"telefonica.es\"\r\n",
	.cmdSize = sizeof("AT+CGDCONT=1,\"IP\",\"telefonica.es\"\r\n")-1,
	.cmdResponseOnOk = GSM_OK_Str,
	.timeoutMs = 3000,
	.delayMs = 2000,
	.skip = 0,
...
static GSM_Cmd cmd_Soc =
{
	.cmd = "AT#SCFG=1,1,300,90,600,50\r\n",
	.cmdSize = sizeof("AT#SCFG=1,1,300,90,600,50\r\n")-1,
...
static GSM_Cmd cmd_Cereg =
{
	.cmd = "AT+CEREG?\r\n",
	.cmdSize = sizeof("AT+CEREG?\r\n")-1,
	.cmdResponseOnOk = "+CEREG: 0,5",
	.timeoutMs = 8000,
	.delayMs = 4000,
	.skip = 0,
};
...
static GSM_Cmd cmd_Connect_2 =
{
	.cmd = "AT+CGCONTRDP\r\n",
	.cmdSize = sizeof("AT+CGCONTRDP\r\n")-1,
	.cmdResponseOnOk = GSM_OK_Str,
	.timeoutMs = 6000,
	.delayMs = 1000,
	.skip = 0,
...
static int atCmd_waitResponse(char * cmd, char *resp, char * resp1, int cmdSize, int timeout, char **response, int size)
{
	...
	while(1)
	{
		...
		if (len > 0) {
			...
			if (tot > 0) {
				// Check the response
				if ((strstr(sresp, resp) != NULL) || (strstr(resp, "SGACT:") != NULL)) {
					#if GSM_DEBUG
...
static void pppos_client_task()
{
	...
	while(1)
	{
		...
		#endif
		ESP_LOGI(TAG,"GSM Inicializado correctamente.");
