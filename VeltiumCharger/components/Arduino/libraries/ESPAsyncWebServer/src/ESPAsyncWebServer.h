...
#ifndef WEBSERVER_H
typedef enum {
  HTTP_GET_A     = 0b00000001,
  HTTP_POST_A    = 0b00000010,
  HTTP_DELETE_A = 0b00000100,
  HTTP_PUT_A     = 0b00001000,
  HTTP_PATCH_A   = 0b00010000,
  HTTP_HEAD_A    = 0b00100000,
  HTTP_OPTIONS_A = 0b01000000,
  HTTP_ANY_A     = 0b01111111,
} WebRequestMethod;
#endif
