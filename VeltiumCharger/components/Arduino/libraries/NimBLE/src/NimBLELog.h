...
#else
#define NIMBLE_LOGE( tag, format, ... ) Serial.printf((ml_msg_), ##__VA_ARGS__)
#define NIMBLE_LOGW( tag, format, ... ) Serial.printf((ml_msg_), ##__VA_ARGS__)
#define NIMBLE_LOGI( tag, format, ... ) Serial.printf((ml_msg_), ##__VA_ARGS__)
#define NIMBLE_LOGD( tag, format, ... ) Serial.printf((ml_msg_), ##__VA_ARGS__)
