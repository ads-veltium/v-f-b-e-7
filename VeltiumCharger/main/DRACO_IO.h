...
#define GPIO_MODEM_PWR_EN		15   //SIGNAL TO POWER-ON/OFF MODEM
#define EMAC_nRESET				32	//RESET OF PHY ETHERNET SWITCH IC
...
#define GPIO_UART1_TX_MODEM		12	//UART TO MODEM
