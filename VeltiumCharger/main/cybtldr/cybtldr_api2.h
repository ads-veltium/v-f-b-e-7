...
#include "cybtldr_utils.h"
     ...
     *
     *******************************************************************************/
    EXTERN int CALL_CON CyBtldr_Program(const char *file, HardwareSerialMOD *comm, CyBtldr_ProgressUpdate *update);
     ...
     *
     *******************************************************************************/
    EXTERN int CALL_CON CyBtldr_Erase(const char *file, HardwareSerialMOD *comm, CyBtldr_ProgressUpdate *update);
     ...
     *
     *******************************************************************************/
    EXTERN int CALL_CON CyBtldr_Verify(const char *file, HardwareSerialMOD *comm, CyBtldr_ProgressUpdate *update);
