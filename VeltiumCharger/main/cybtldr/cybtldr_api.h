 ...
 *
 * Parameters:
     *   ReceivedChannel   – Communication struct used for communicating with the target device
 ...
 *
 *******************************************************************************/
    EXTERN int CyBtldr_StartBootloadOperation(HardwareSerialMOD *ReceivedChannel, uint32_t expSiId, uint8_t expSiRev, uint32_t *blVer,
                                          uint32_t productID);
